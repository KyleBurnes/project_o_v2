...
<h1 style="font-size: 26pt; margin: 33px auto 33px auto; text-align:center;">Ваш профиль</h1>
...
<div class="prof__sect">
    ...
    <div class="prof__wrapper">
        <div class="user__tab">
            ...
            <div class="user__pic">
                ...
                <?php if($checkUserP->num_rows !== 0):?>
                <div class="user__edit"><p><a href="profile_edit.php?sender=profile">Редактировать профиль</a></p></div>
                <?endif;?>
    ...
    <div class="user__reach">
        <div class="reach__wrapper">
            ...
            <div class="add__reach"><button id="reach__btn">+ Добавить</button> <span id="reach__err"><?=$_SESSION['error']['reach']?></span></div>
            ...
            <div class="reach__cards">
                ...
                <?php foreach ($userContact as $key => $value):?>
                    <div class="reach__card">
                        <form class="reach__del" action="../actions/user/add_reach.php" method="POST"><input type="hidden" name="reach_id"value="<?=$value['id']?>"><input type="submit" name="del_reach" value="X"></form>
    ...
    <div class="hobbies__sect">
        ...
        <div class="add__reach"><button id="hobby__btn">+ Добавить</button> <span id="reach__err"><?=$_SESSION['error']['reach']?></span></div>
...
<div class="reach__cards">
    ...
    <?php foreach ($userHobbies as $key => $value):?>
        <div class="reach__card">
            <form class="reach__del" action="../actions/user/add_hobby.php" method="POST">
                <input type="hidden" name="hobby_id"value="<?=$value['id']?>"><input type="submit" name="del_hobby" value="X">
            </form>
            <div class="reach__card__title">
